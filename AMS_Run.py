    ...
    def fill_attendance():
        ...
        if subb=='':
            ...
            def err_screen1():
                ...
                Label(errsc2, text='Please enter Candidate & EmployeesID!!!', fg='red', bg='white',
            ...
            ENR = tk.Label(MFW, text="Enter EmployeesID", width=15, height=2, fg="white", bg="blue2",
                           font=('times', 15, ' bold '))
            ENR.place(x=30, y=100)

            STU_NAME = tk.Label(MFW, text="Enter Candidate name", width=15, height=2, fg="white", bg="blue2",
                                font=('times', 15, ' bold '))
            ...
            def create_csv():
                ...
                csv_name='C:/Users/admin/Downloads/Attendace_management_system-master/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(r'explorer /select,"C:/Users/admin/Downloads/Attendace_management_system-master/Attendance/Manually Attendance/-------Check atttendance-------"')
...
def err_screen():
    ...
    Label(sc1,text='EmployeesID & Name required!!!',fg='red',bg='white',font=('times', 16, ' bold ')).pack()
...
def err_screen1():
    ...
    Label(sc2,text='Please enter your Department name!!!',fg='red',bg='white',font=('times', 16, ' bold ')).pack()
...
def take_img():
    ...
    if l1 == '':
        ...
        try:
            cam = cv2.VideoCapture("http://gaurav:gaurav12345@192.168.0.83:8081/video.mjpg")
            detector = cv2.CascadeClassifier('C:/Users/admin/Downloads/Attendace_management_system-master/haarcascade_frontalface_default.xml')
            Enrollment = txt.get()
            Name = txt2.get()
            sampleNum = 0
            while (True):
                ...
                for (x, y, w, h) in faces:
                    ...
                    cv2.imwrite("C:/Users/admin/Downloads/Attendace_management_system-master/TrainingImage/ " + Name + "." + Enrollment + '.' + str(sampleNum) + ".jpg",
                                gray[y:y + h, x:x + w])
            ...
            with open('C:/Users/admin/Downloads/Attendace_management_system-master/StudentDetails/StudentDetails.csv', 'a+') as csvFile:
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                try:
                    recognizer.read("C:/Users/admin/Downloads/Attendace_management_system-master/TrainingImageLabel/Trainner.yml")
                except:
                    e = 'Model not found,Please train model'
                    Notifica.configure(text=e, bg="red", fg="black", width=33, font=('times', 15, 'bold'))
                    Notifica.place(x=20, y=250)

                harcascadePath = "C:/Users/admin/Downloads/Attendace_management_system-master/haarcascade_frontalface_default.xml"
                faceCascade = cv2.CascadeClassifier(harcascadePath);
                df = pd.read_csv("C:/Users/admin/Downloads/Attendace_management_system-master/StudentDetails/StudentDetails.csv")
                cam = cv2.VideoCapture("http://gaurav:gaurav12345@192.168.0.83:8081/video.mjpg")
                ...
                Hour, Minute, Second = timeStamp.split(":")
                ####Creatting csv of attendance
                fileName = "C:/Users/admin/Downloads/Attendace_management_system-master/Attendance/"+Subject+ "_" + date + "_" + Hour + "-" + Minute + "-" + Second +"checkin"+ ".csv"
                ...
                root.configure(background='snow')
                cs = 'C:/Users/admin/Downloads/Attendace_management_system-master/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(r'explorer /select,"C:/Users/admin/Downloads/Attendace_management_system-master/Attendance/-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'gaurav' :
            if password == 'gaurav12345':
                ...
                cs = 'C:/Users/admin/Downloads/Attendace_management_system-master/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
...
def trainimg():
    ...
    try:
        global faces,Id
        faces, Id = getImagesAndLabels("C:/Users/admin/Downloads/Attendace_management_system-master/TrainingImage")
    except Exception as e:
    ...
    try:
        recognizer.save("C:/Users/admin/Downloads/Attendace_management_system-master/TrainingImageLabel/Trainner.yml")
    except Exception as e:
...
lbl = tk.Label(window, text="Enter EmployeesID", width=20, height=2, fg="black", bg="deep pink", font=('times', 15, ' bold '))
...
AP = tk.Button(window, text="Check Register employees",command=admin_panel,fg="black"  ,bg="cyan"  ,width=19 ,height=1, activebackground = "Red" ,font=('times', 15, ' bold '))
